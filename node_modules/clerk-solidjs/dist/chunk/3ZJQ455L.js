...
import { createDevOrStagingUrlCache, isPublishableKey } from '@clerk/shared/keys';
import { createContext, useContext, createEffect, onCleanup, splitProps, createSignal, createMemo, untrack, on } from 'solid-js';
import { createContextProvider } from '@solid-primitives/context';
import '@clerk/shared/loadScript';
...
function withMaxAllowedInstancesGuard(WrappedComponent, name, error) {
  const HOC = (props) => {
    ...
    return createComponent(WrappedComponent, props);
  };
  return HOC;
}
...
var ClerkInstanceContextProvider = (props) => {
  return createComponent(ClerkInstanceContext.Provider, {
    get value() {
      return props.clerk;
    },
    get children() {
...
function ClerkContextProvider(props) {
  ...
  const derivedState = createMemo(() => deriveState(clerkLoaded(), state(), props.initialState));
  const clerkCtx = () => clerkLoaded() ? clerk() : clerk();
  return createComponent(IsomorphicClerkContextProvider, {
    clerk: clerkCtx,
    get children() {
      return createComponent(ClientContextProvider, {
        client: () => state().client,
        get children() {
          return createComponent(SessionContextProvider, {
            session: () => derivedState().session,
            get children() {
              return createComponent(OrganizationContextProvider, {
                organization: () => derivedState().organization,
                get children() {
                  return createComponent(AuthContextProvider, {
                    ...
                    get children() {
                      return createComponent(UserContextProvider, {
...
var useLoadedIsomorphicClerk = (options) => {
  ...
  const isomorphicClerk = createMemo(() => IsomorphicClerk.getOrCreateInstance(untrack(options)));
  createEffect(on(() => options().appearance, (appearance) => {
    void isomorphicClerk().__unstable__updateProps({
      appearance
    });
  }));
  createEffect(on(() => options().localization, (localization) => {
    void isomorphicClerk().__unstable__updateProps({
      options: {
        localization
      }
...
function ClerkProviderBase(props) {
  const [local, restIsomorphicClerkOptions] = splitProps(props, ["initialState", "children"]);
  createEffect(() => {
  ...
  return createComponent(ClerkContextProvider, {
    get initialState() {
...
export { ClerkInstanceContext, ClerkProvider, assertSingleChild, errorThrower, normalizeWithDefaultValue, organizationProfileLinkRenderedError, organizationProfilePageRenderedError, safeExecute, setErrorThrowerOptions, useAuthContext, useAuthHasRequiresRoleOrPermission, useClerkInstanceContext, useClientContext, useIsomorphicClerkContext, useOrganizationContext, useSessionContext, useUserContext, userProfileLinkRenderedError, userProfilePageRenderedError };
