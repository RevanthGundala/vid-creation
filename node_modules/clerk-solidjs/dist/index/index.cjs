...
exports.Protect = (props) => {
  ...
  const unauthorized = web.memo(() => local.fallback ?? null);
  const authorized = web.memo(() => local.children);
  return web.createComponent(solidJs.Switch, {
    ...
    get children() {
      return [web.createComponent(solidJs.Match, {
        ...
        get when() {
          return web.memo(() => typeof restAuthorizedParams.condition === "function")() && restAuthorizedParams.condition(has);
        },
        children: authorized
      }), web.createComponent(solidJs.Match, {
        get when() {
          return web.memo(() => !!(restAuthorizedParams.role || restAuthorizedParams.permission))() && has(restAuthorizedParams);
        },
        children: authorized
      })];
    }
...
exports.SignInButton = withClerk((props) => {
  ...
  return (() => {
    ...
    web.insert(_el$, child);
    return _el$;
  })();
}, "SignInButton");
var _tmpl$2 = /* @__PURE__ */ web.template(`<button>`);
...
var _tmpl$3 = /* @__PURE__ */ web.template(`<button>`);
...
var _tmpl$4 = /* @__PURE__ */ web.template(`<button>`);
...
var _tmpl$5 = /* @__PURE__ */ web.template(`<div>`);
