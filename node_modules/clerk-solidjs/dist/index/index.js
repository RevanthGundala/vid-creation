...
export { ClerkProvider } from '../chunk/AKK762YZ.js';
import { setErrorThrowerOptions, errorThrower } from '../chunk/ZQDJMLYE.js';
import { spread, mergeProps, insert, createComponent, memo, template, use } from 'solid-js/web';
...
var Protect = (props) => {
  ...
  const unauthorized = memo(() => local.fallback ?? null);
  const authorized = memo(() => local.children);
  return createComponent(Switch, {
    ...
    get children() {
      return [createComponent(Match, {
        ...
        get when() {
          return memo(() => typeof restAuthorizedParams.condition === "function")() && restAuthorizedParams.condition(has);
        },
        children: authorized
      }), createComponent(Match, {
        get when() {
          return memo(() => !!(restAuthorizedParams.role || restAuthorizedParams.permission))() && has(restAuthorizedParams);
        },
        children: authorized
      })];
    }
